...
// 
byte previousButtonStates[12];
byte currentButtonStates[12];
  ...
  if (DecodeData == 1 && bleGamepad.isConnected()) {
    ...
    //Buttons
     ...
     // }
      ...
      // This is an easy place to flip the X and Yresults if backwards for your use case
      ...
      char trbuf[] = "00";
        ...
        bleLTrigger = map(ltValue, 0, 15, 1, 32767);
        ...
        //bleRTrigger = map(rtValue, 0, 15, 32767, -32767);
        bleRTrigger = map(rtValue, 0, 15, 1, 32767);
        bleGamepad.setRightTrigger(bleRTrigger);
